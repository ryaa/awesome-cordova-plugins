...
var BackgroundGeolocation = /** @class */ (function (_super) {
    ...
    BackgroundGeolocation.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: BackgroundGeolocation, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    BackgroundGeolocation.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: BackgroundGeolocation });
    ...
    BackgroundGeolocation = tslib.__decorate([], BackgroundGeolocation);
    return BackgroundGeolocation;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: BackgroundGeolocation, decorators: [{
            type: i0.Injectable
        }], propDecorators: { configure: [], start: [], stop: [], finish: [], changePace: [], setConfig: [], getStationaryLocation: [], onStationary: [], isLocationEnabled: [], showAppSettings: [], showLocationSettings: [], watchLocationMode: [], stopWatchingLocationMode: [], getLocations: [], getValidLocations: [], deleteLocation: [], deleteAllLocations: [], switchMode: [], getLogEntries: [], getConfig: [], getCurrentLocation: [], checkStatus: [], startTask: [], endTask: [], headlessTask: [], forceSync: [], on: [], removeAllListeners: [] } });
