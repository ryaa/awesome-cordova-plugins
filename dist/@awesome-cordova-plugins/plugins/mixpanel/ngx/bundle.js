...
var Mixpanel = /** @class */ (function (_super) {
    ...
    Mixpanel.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: Mixpanel, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    Mixpanel.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: Mixpanel });
    ...
    Mixpanel = tslib.__decorate([], Mixpanel);
    return Mixpanel;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: Mixpanel, decorators: [{
            type: i0.Injectable
        }], propDecorators: { alias: [], distinctId: [], flush: [], identify: [], init: [], getSuperProperties: [], registerSuperProperties: [], registerSuperPropertiesOnce: [], unregisterSuperProperty: [], reset: [], timeEvent: [], track: [] } });
var MixpanelPeople = /** @class */ (function (_super) {
    ...
    MixpanelPeople.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: MixpanelPeople, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    MixpanelPeople.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: MixpanelPeople });
    MixpanelPeople.plugin = "cordova-plugin-mixpanel";
    MixpanelPeople.pluginRef = "mixpanel.people";
    MixpanelPeople.pluginName = "Mixpanel";
    MixpanelPeople = tslib.__decorate([], MixpanelPeople);
    return MixpanelPeople;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: MixpanelPeople, decorators: [{
            type: i0.Injectable
        }], propDecorators: { append: [], deleteUser: [], identify: [], increment: [], setPushId: [], set: [], setOnce: [], trackCharge: [], unset: [], union: [] } });
