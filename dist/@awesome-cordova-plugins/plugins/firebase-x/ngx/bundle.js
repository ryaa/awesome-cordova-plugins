...
var FirebaseX = /** @class */ (function (_super) {
    ...
    FirebaseX.prototype.incrementCounter = function (name, counterName) { return core.cordova(this, "incrementCounter", {}, arguments); };
    ...
    FirebaseX.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: FirebaseX, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    FirebaseX.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: FirebaseX });
    ...
    FirebaseX = tslib.__decorate([], FirebaseX);
    return FirebaseX;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: FirebaseX, decorators: [{
            type: i0.Injectable
        }], propDecorators: { getToken: [], getId: [], getCurrentUser: [], reloadCurrentUser: [], onTokenRefresh: [], getAPNSToken: [], onApnsTokenReceived: [], onMessageReceived: [], grantPermission: [], hasPermission: [], unregister: [], setBadgeNumber: [], getBadgeNumber: [], clearAllNotifications: [], subscribe: [], unsubscribe: [], isAutoInitEnabled: [], setAutoInitEnabled: [], createChannel: [], setDefaultChannel: [], deleteChannel: [], listChannels: [], setAnalyticsCollectionEnabled: [], setCrashlyticsCollectionEnabled: [], setPerformanceCollectionEnabled: [], logEvent: [], setScreenName: [], setUserId: [], setUserProperty: [], setCrashlyticsUserId: [], sendCrash: [], logMessage: [], logError: [], verifyPhoneNumber: [], setLanguageCode: [], signInWithCredential: [], createUserWithEmailAndPassword: [], signInUserWithEmailAndPassword: [], signInUserWithCustomToken: [], signInUserAnonymously: [], authenticateUserWithGoogle: [], authenticateUserWithApple: [], linkUserWithCredential: [], reauthenticateWithCredential: [], isUserSignedIn: [], signOutUser: [], updateUserProfile: [], updateUserEmail: [], sendUserEmailVerification: [], updateUserPassword: [], sendUserPasswordResetEmail: [], deleteUser: [], registerAuthStateChangeListener: [], fetch: [], activateFetched: [], getValue: [], getByteArray: [], getInfo: [], setConfigSettings: [], setDefaults: [], startTrace: [], incrementCounter: [], stopTrace: [], addDocumentToFirestoreCollection: [], setDocumentInFirestoreCollection: [], updateDocumentInFirestoreCollection: [], deleteDocumentFromFirestoreCollection: [], fetchDocumentInFirestoreCollection: [], fetchFirestoreCollection: [] } });
