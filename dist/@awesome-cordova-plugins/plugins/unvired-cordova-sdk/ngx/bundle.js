...
var UnviredCordovaSDK = /** @class */ (function (_super) {
    ...
    UnviredCordovaSDK.prototype.refreshJWTToken = function () { return core.cordova(this, "refreshJWTToken", {}, arguments); };
    UnviredCordovaSDK.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: UnviredCordovaSDK, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    UnviredCordovaSDK.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: UnviredCordovaSDK });
    ...
    UnviredCordovaSDK = tslib.__decorate([], UnviredCordovaSDK);
    return UnviredCordovaSDK;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: UnviredCordovaSDK, decorators: [{
            type: i0.Injectable
        }], propDecorators: { logDebug: [], logError: [], logInfo: [], logRead: [], logDelete: [], sendLogToServer: [], sendLogViaEmail: [], getLogLevel: [], getLogFilePath: [], setLogLevel: [], login: [], loginWithDemoData: [], logout: [], authenticateAndActivate: [], authenticateLocal: [], getAllAccounts: [], switchAccount: [], deleteAccount: [], getInfoMessages: [], showSettings: [], userSettings: [], updateSystemCredentials: [], getSystemCredentials: [], getVersionNumbers: [], clearData: [], hasInternet: [], guid: [], pullDb: [], pushDb: [], dbSelect: [], dbInsert: [], dbInsertOrUpdate: [], dbDelete: [], dbUpdate: [], dbExecuteStatement: [], dbCreateSavePoint: [], dbReleaseSavePoint: [], dbRollbackToSavePoint: [], dbBeginTransaction: [], dbEndTransaction: [], dbSaveWebData: [], dbExportWebData: [], launchFile: [], launchBase64: [], unzip: [], getAttachmentFolderPath: [], createAttachmentItem: [], uploadAttachment: [], downloadAttachment: [], syncForeground: [], syncBackground: [], getSynchronizationState: [], dbReload: [], generateUBJson: [], parseRawUBJson: [], dbGetCollection: [], getMessages: [], registerNotifListener: [], isInOutBox: [], outBoxItemCount: [], isInSentItem: [], sentItemCount: [], inBoxItemCount: [], deleteOutBoxEntry: [], resetApplicationSyncData: [], reCreateAppDB: [], startInboxHandler: [], startDataSender: [], platform: [], testPushNotification: [], lockDataSender: [], unlockDataSender: [], removeOutObjectBasedOnLid: [], startDiscoveryService: [], setClientCredentials: [], isClientCredentialsSet: [], encrypt: [], decrypt: [], registerForPushNotification: [], refreshJWTToken: [] } });
