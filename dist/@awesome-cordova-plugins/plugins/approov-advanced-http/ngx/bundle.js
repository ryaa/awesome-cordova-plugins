...
var ApproovHttp = /** @class */ (function (_super) {
    ...
    ApproovHttp.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: ApproovHttp, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ApproovHttp.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: ApproovHttp });
    ...
    ApproovHttp = tslib.__decorate([], ApproovHttp);
    return ApproovHttp;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: ApproovHttp, decorators: [{
            type: i0.Injectable
        }], propDecorators: { ErrorCode: [], getBasicAuthHeader: [], useBasicAuth: [], getHeaders: [], setHeader: [], getDataSerializer: [], setDataSerializer: [], setCookie: [], clearCookies: [], removeCookies: [], getCookieString: [], getRequestTimeout: [], setRequestTimeout: [], getFollowRedirect: [], setFollowRedirect: [], setServerTrustMode: [], post: [], postSync: [], get: [], getSync: [], put: [], putSync: [], patch: [], patchSync: [], delete: [], deleteSync: [], head: [], headSync: [], options: [], optionsSync: [], uploadFile: [], uploadFileSync: [], downloadFile: [], downloadFileSync: [], sendRequest: [], sendRequestSync: [], abort: [], initializeApproov: [], approovSetDataHashInToken: [], approovSetBindingHeader: [], getApproovLoggableToken: [] } });
